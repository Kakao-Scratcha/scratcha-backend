...
Revision ID: c10d031d1b44
Revises: 
Create Date: 2025-08-14 01:54:00.131825
...
def upgrade() -> None:
    ...
    sa.Column('result', sa.Enum('SUCCESS', 'FAIL', name='captcharesult'), nullable=False, comment='성공 / 실패 결과'),
    sa.Column('latency_ms', sa.Integer(), nullable=False, comment='응답 지연 시간 (ms)'),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False, comment='생성 시각'),
